...
namespace BerlinClock.Classes.BerlinClock
{
    ...
    internal class ClockRow
    {
        ...
        private readonly Func<DateTime, int> _timeComponentExtractor;
        private readonly Func<int, int> _numberOfLampsToSwitchOn;
        private readonly Func<int, LampState> _lampSwitchingOnFunc;
        internal ClockRow(int numberOfLamps, Func<DateTime, int> timeComponentExtractor, Func<int, int> numberOfLampsToSwitchOn, Func<int, LampState> lampSwitchingOnFunc)
        {
        ...
        internal void SwitchOn(DateTime time)
        {
            var lampsToSwitchOn = _numberOfLampsToSwitchOn(_timeComponentExtractor(time));
